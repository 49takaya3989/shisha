...
export const ADMIN_BLOG_EDIT = {
  ...
  INPUT: {
    ...
    CONTENTS_PLACEHOLDER: 'コンテンツ',
    THUMBNAIL_LABEL: 'サムネイル',
    THUMBNAIL_SELECT: '画像を選択',
    THUMBNAIL_CLEAR: 'クリア',
    EDITOR_IMAGE_BTN: '画像',
    EDITOR_TEXT_AMOUNT: '文字',
    MODAL_TAB_IMAGE_SELECT: '選択',
    MODAL_TAB_IMAGE_UPLOAD: 'アップロード',
    MODAL_IMAGE_GET: '取得',
    MODAL_IMAGE_SELECT: '選択',
    MODAL_IMAGE_DROP_OR_CLICK: '画像をドロップするかここをクリックしてください',
    MODAL_IMAGE_UPLOAD: '画像をドロップするかここをクリックしてください',
    ERROR: {
      TITLE: 'タイトルを入力してください',
      CONTENTS: 'コンテンツを入力してください',
    },
