...
export type GetBlogsForUserArchiveQueryVariables = Types.Exact<{
  [key: string]: never
}>

export type GetBlogsForUserArchiveQuery = {
...
export type GetBlogsForUserArchiveFragmentFragment = {
  __typename?: 'blogs'
  id: number
  title: string
  slug: string
...
export function useGetBlogsForUserArchiveQuery(
  options?: Omit<
    Urql.UseQueryArgs<GetBlogsForUserArchiveQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
    GetBlogsForUserArchiveQuery,
    GetBlogsForUserArchiveQueryVariables
  >({ query: GetBlogsForUserArchiveDocument, ...options })
}
