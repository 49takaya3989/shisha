...
export type GetBlogsForUserArchiveQuery = { __typename?: 'query_root', blogs: Array<{ __typename?: 'blogs', id: number, title: string, slug: string, contents?: string | null, thumbnail?: string | null, blog_blog_tags: Array<{ __typename?: 'blog_blog_tags', blog_tag: { __typename?: 'blog_tags', id: number, name: string } }> }> };

export type GetBlogsForUserArchiveFragmentFragment = { __typename?: 'blogs', id: number, title: string, slug: string, contents?: string | null, thumbnail?: string | null, blog_blog_tags: Array<{ __typename?: 'blog_blog_tags', blog_tag: { __typename?: 'blog_tags', id: number, name: string } }> };
