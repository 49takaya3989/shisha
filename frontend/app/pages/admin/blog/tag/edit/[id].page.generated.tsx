...
export type BlogTagsByPkForAdminBlogTagEditQuery = {
...
export type BlogTagsFragmentForAdminTagEditFragment = {
  __typename?: 'blog_tags'
  id: number
  name: string
  slug: string
...
export type UpdateBlogTagsByPkForAdminMutation = {
...
export type BlogTagsFragmentForAdminBlogTagUpdateFragment = {
  __typename?: 'blog_tags'
  id: number
  name: string
}
...
export function useBlogTagsByPkForAdminBlogTagEditQuery(
  options: Omit<
    Urql.UseQueryArgs<BlogTagsByPkForAdminBlogTagEditQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
    BlogTagsByPkForAdminBlogTagEditQuery,
    BlogTagsByPkForAdminBlogTagEditQueryVariables
  >({ query: BlogTagsByPkForAdminBlogTagEditDocument, ...options })
}
...
export function useUpdateBlogTagsByPkForAdminMutation() {
  return Urql.useMutation<
    UpdateBlogTagsByPkForAdminMutation,
    UpdateBlogTagsByPkForAdminMutationVariables
  >(UpdateBlogTagsByPkForAdminDocument)
}
