...
export type GetBlogsByPkQuery = { __typename?: 'query_root', blogs_by_pk?: { __typename?: 'blogs', id: number, title: string, slug?: string | null, contents?: string | null, blog_blog_tags: Array<{ __typename?: 'blog_blog_tags', blog_tag: { __typename?: 'blog_tags', id: number, name: string, slug: string } }> } | null };
...
export type InsertBlogBlogTagsMutation = { __typename?: 'mutation_root', insert_blog_blog_tags?: { __typename?: 'blog_blog_tags_mutation_response', returning: Array<{ __typename?: 'blog_blog_tags', id: number, blog_id: number, blog_tag_id: number }> } | null };
...
export type DeleteBlogBlogTagsMutation = { __typename?: 'mutation_root', delete_blog_blog_tags?: { __typename?: 'blog_blog_tags_mutation_response', returning: Array<{ __typename?: 'blog_blog_tags', id: number, blog_id: number, blog_tag_id: number }> } | null };
...
export function useGetBlogsByPkQuery(options: Omit<Urql.UseQueryArgs<GetBlogsByPkQueryVariables>, 'query'>) {
  return Urql.useQuery<GetBlogsByPkQuery, GetBlogsByPkQueryVariables>({ query: GetBlogsByPkDocument, ...options });
};
export const UpdateBlogsByPkDocument = gql`
    mutation updateBlogsByPk($pk_columns: blogs_pk_columns_input!, $_set: blogs_set_input) {
...
export function useUpdateBlogsByPkMutation() {
  return Urql.useMutation<UpdateBlogsByPkMutation, UpdateBlogsByPkMutationVariables>(UpdateBlogsByPkDocument);
};
export const InsertBlogBlogTagsDocument = gql`
    mutation insertBlogBlogTags($objects: [blog_blog_tags_insert_input!]!, $on_conflict: blog_blog_tags_on_conflict) {
...
export function useInsertBlogBlogTagsMutation() {
  return Urql.useMutation<InsertBlogBlogTagsMutation, InsertBlogBlogTagsMutationVariables>(InsertBlogBlogTagsDocument);
};
...
export function useDeleteBlogBlogTagsMutation() {
  return Urql.useMutation<DeleteBlogBlogTagsMutation, DeleteBlogBlogTagsMutationVariables>(DeleteBlogBlogTagsDocument);
};