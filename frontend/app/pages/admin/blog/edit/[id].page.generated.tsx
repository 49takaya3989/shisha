...
export type BlogsByPkForAdminBlogEditQuery = {
  __typename?: 'query_root'
  blogs_by_pk?: {
    __typename?: 'blogs'
    id: number
...
export type UpdateBlogsByPkForAdminBlogEditMutation = {
...
export type InsertBlogBlogTagsForAdminBlogEditMutation = {
  __typename?: 'mutation_root'
...
export type DeleteBlogBlogTagsForAdminBlogEditMutation = {
  __typename?: 'mutation_root'
...
export type BlogsFragmentForAdminBlogEditFragment = {
  __typename?: 'blogs'
  id: number
  title: string
  slug: string
...
export function useBlogsByPkForAdminBlogEditQuery(
  options: Omit<
    Urql.UseQueryArgs<BlogsByPkForAdminBlogEditQueryVariables>,
    'query'
  >
) {
  return Urql.useQuery<
    BlogsByPkForAdminBlogEditQuery,
    BlogsByPkForAdminBlogEditQueryVariables
  >({ query: BlogsByPkForAdminBlogEditDocument, ...options })
}
...
export function useUpdateBlogsByPkForAdminBlogEditMutation() {
  return Urql.useMutation<
    UpdateBlogsByPkForAdminBlogEditMutation,
    UpdateBlogsByPkForAdminBlogEditMutationVariables
  >(UpdateBlogsByPkForAdminBlogEditDocument)
}
...
export function useInsertBlogBlogTagsForAdminBlogEditMutation() {
  return Urql.useMutation<
    InsertBlogBlogTagsForAdminBlogEditMutation,
    InsertBlogBlogTagsForAdminBlogEditMutationVariables
  >(InsertBlogBlogTagsForAdminBlogEditDocument)
}
...
export function useDeleteBlogBlogTagsForAdminBlogEditMutation() {
  return Urql.useMutation<
    DeleteBlogBlogTagsForAdminBlogEditMutation,
    DeleteBlogBlogTagsForAdminBlogEditMutationVariables
  >(DeleteBlogBlogTagsForAdminBlogEditDocument)
}
